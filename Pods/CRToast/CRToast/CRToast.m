...
static BOOL                         kCRUnderStatusBarDefault                = YES;
...
static CGRect CRNotificationViewFrame(CRToastType type, CRToastAnimationDirection direction) {
    return CGRectMake(direction == CRToastAnimationDirectionLeft ? -CRGetStatusBarWidth() : direction == CRToastAnimationDirectionRight ? CRGetStatusBarWidth() : 0,
                      20 + direction == CRToastAnimationDirectionTop ? -CRGetNotificationViewHeight(type) : direction == CRToastAnimationDirectionBottom ? CRGetNotificationViewHeight(type) : 0,
                      CRGetStatusBarWidth(),
                      CRGetNotificationViewHeight(type) - 20.0);
}
...
- (UIView*)notificationView {
    ...
    CRToastView *notificationView = [[CRToastView alloc] initWithFrame:CGRectMake(0, 20.0, size.width, size.height)];
...
- (void)displayNotification:(CRToast*)notification {
    ...
    if ([UIApplication sharedApplication].statusBarOrientation == UIInterfaceOrientationLandscapeLeft) {
        ...
        _notificationWindow.rootViewController.view.frame = CGRectMake(0, 20.0, notificationSize.width, notificationSize.height - 20.0);
    }
